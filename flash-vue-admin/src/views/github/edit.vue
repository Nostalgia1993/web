  ...
  <div class="app-container">
    <div class="block">
      <el-form ref="form" :model="form">
        <el-input type="hidden" ref="content" v-model="form.emailAddress"></el-input>
        <el-input type="hidden" ref="content" v-model="form.githubName"></el-input>
        <el-input type="hidden" ref="content" v-model="form.repositoryName"></el-input>
        <el-input type="hidden" ref="content" v-model="form.repositoryName"></el-input>
        <el-input type="hidden" ref="content" v-model="form.sshUrl"></el-input>
        <el-row :gutter="20">
            <el-col :span="24">
